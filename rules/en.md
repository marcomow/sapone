...
- **The seller evaluates the offers and will ask for more if they're not satisfied**; if an agreement is reached, the players exchange the cards (the buyer may be entitled to a purchase compensation, see #4.1.3purchase-compensation).
...
## **6. Combinations and Examples**

### **6.1 Most of (Coins, Soap)**
...
### **6.3 Best Collection (Vegetables, Tools)**
...
#### **6.4 Breaking ties for Best Collection**
